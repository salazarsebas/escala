...
const STEPS = [
  {
    n: "01",
    title: "Crea y financia tu campaña",
    detail: "Define el valor de cada resultado y tu presupuesto en USDC.",
  },
  {
    n: "02",
    title: "Conecta con tu promotor",
    detail: "ESCALA genera un QR y un enlace único para compartir.",
  },
  {
    n: "03",
    title: "El cliente realiza la acción",
    detail: "Reserva, compra o registro desde una página pública simple.",
  },
  {
    n: "04",
    title: "Se valida y se libera",
    detail: "Al confirmar la conversión, la recompensa se libera en USDC.",
  },
];
    ...
    <div>
      ...
      <section className="mx-auto max-w-5xl px-6 pb-20 pt-16 sm:pt-24">
        ...
        <p className="mt-6 max-w-2xl text-lg text-neutral-600 dark:text-neutral-400">
          Conecta tu negocio con promotores, mide conversiones y recompensa únicamente los
          resultados validados. Sin asumir todo el costo de adquisición por adelantado.
        </p>
        ...
        <div className="mt-16 grid gap-4 sm:grid-cols-3">
          <Feature
            ...
            detail="Solo pagas cuando una conversión se valida. Nada de pagar por clics o impresiones."
          />
          <Feature
            icon={<Wallet size={18} />}
            title="Wallet en un clic"
            detail="Login social con Cavos: tu wallet en Stellar se crea automáticamente, sin frases semilla."
          />
          <Feature
            icon={<QrCode size={18} />}
            title="Recompensas digitales"
            detail="Las recompensas se liberan en USDC, un dólar digital, de forma clara y trazable."
          />
        </div>
      </section>
      ...
      <section id="como-funciona" className="border-t border-neutral-100 py-16 dark:border-neutral-900">
        <div className="mx-auto max-w-5xl px-6">
          <h2 className="text-3xl font-bold text-neutral-900 dark:text-white">Cómo funciona</h2>
          <p className="mt-2 max-w-2xl text-neutral-600 dark:text-neutral-400">
            Un negocio define cuánto vale un resultado, un promotor lo consigue, ESCALA lo
            identifica, la conversión se valida y la recompensa se libera.
          </p>
        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            <MiniFeature
              ...
              detail="El presupuesto se bloquea y solo se libera cuando se cumple una condición verificable."
            />
            <MiniFeature
            ...
            <MiniFeature
              ...
              detail="Comisiones de fracción de centavo, ideales para micropagos y recompensas pequeñas."
            />
            <MiniFeature
              title="Evidencia on-chain"
              detail="Cada campaña, depósito y pago queda registrado y verificable en StellarView."
            />
          </div>
        </div>
      </section>
      ...
      <section className="border-t border-neutral-100 py-16 dark:border-neutral-900">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <p className="mt-4 text-neutral-600 dark:text-neutral-400">
            ESCALA permite crear campañas, reservar un presupuesto en USDC y pagar
            automáticamente a promotores cuando generan resultados verificables, mientras
